...
public class ContaCorrente extends Contas{
	...
	public void transferir() {
		ContaCorrente cc;
		int contaParaDeposito = Integer.parseInt(JOptionPane.showInputDialog("Digite a conta corrente que deseja transferir: "));
		Double valor = Double.parseDouble(JOptionPane.showInputDialog("Digite o valor que deseja transferir: "));
		if (valor > 0 && valor <= this.getSaldo()) {
			this.setSaldo(this.getSaldo() - valor);
