...
public class ContaPoupanca extends Contas {
	...
	public ContaPoupanca(Contas conta) {
		//this.ID = conta.getID();
		//StringBuffer sb = new StringBuffer(conta.Co.get(0));
	...
	public void resgatar(ContaCorrente destino) {
		...
		if (getSaldo() >= valor) {
			...
			JOptionPane.showMessageDialog(null, "O valor de " + Utils.doubleToString(valor) + " foi resgatado na Conta Corrente com sucesso!");
		} else {
