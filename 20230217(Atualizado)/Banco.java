...
public class Banco {
	...
	public static void menuCliente(Contas a) {
	...
	public static void modificarCadastro(Contas a) {
		...
		contas.set(contasC.getID() - 1, a);
		contasCorrente.set(cc.getID() - 1, cc);
		contasPoupanca.add(cp.getID() - 1, cp);
