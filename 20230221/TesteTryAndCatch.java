...
public class TesteTryAndCatch {
	...
	public static void criarConta() {
		...
		if (pessoa.getNome() == null) {
			JOptionPane.showMessageDialog(null, "Cancelado. Nome!");
			menu();
		...
		if (pessoa.getCpf() == null) {
			JOptionPane.showMessageDialog(null, "Cancelado. CPF!");
			menu();
		} else if (pessoa.getCpf().equalsIgnoreCase("")) {
			JOptionPane.showMessageDialog(null, "Campo Vazio. CPF!");
			menu();
		...
		if (pessoa.getEmail() == null) {
			JOptionPane.showMessageDialog(null, "Cancelado. E-mail!");
			menu();
		} else if (pessoa.getEmail().equalsIgnoreCase("")) {
			JOptionPane.showMessageDialog(null, "Campo Vazio. E-mail!");
			menu();
		}
