...
public class Banco {
	...
	public static void menuGerente(ContaCorrente b, ContaPoupanca c) {
		...
		int menu = Integer.parseInt(JOptionPane.showInputDialog(
				"                                   -------------------------------------------------------------------"
						...
						+ "                                            \n                                   |            Opção 3 - Encontrar Dados Cadastrais |"
						+ "                                            \n                                   |            Opção 4 - Listar                                           |"
						+ "                                            \n                                   |            Opção 5 - Sair                                              |"
						+ "                                            \n                                   -------------------------------------------------------------------"
						+ ""));
	...
	public static ContaCorrente encontrarCadastro(ContaCorrente b, ContaPoupanca c) {
		Pessoa pessoa = new Pessoa();
		pessoa.setCpf(JOptionPane.showInputDialog("Digite CPF:"));
		ContaCorrente conta = null;
		for (ContaCorrente d : contasCorrente) {
			if (d.getPessoa().getCpf().equals(pessoa.getCpf())) {
				conta = d;
			}
		}
		if (conta == null) {
